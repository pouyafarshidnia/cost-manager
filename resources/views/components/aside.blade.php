<aside x-data="{ routeName: '{{ request()->route()->getName() }}' }"
    class="w-64 bg-white border-r border-gray-200 h-[calc(100vh-4rem)] sticky top-16 overflow-y-auto">
    <nav class="p-4 space-y-1">

        <a href="{{ route('home') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium  transition-colors"
            :class="routeName === 'home' ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50'">
