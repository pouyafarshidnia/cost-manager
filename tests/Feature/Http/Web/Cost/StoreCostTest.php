...
describe('access tests', function () {
    ...
    it('renders successfuly for authenticated user', function () {
        ...
        $this->actingAs($this->user)->post($this->url, $this->data)->assertRedirect(route('costs.index'));
    });
});
...
describe('validation tests', function () {
    ...
    it('validates category id properly', function (mixed $category_id) {
        ...
        $this->actingAs($this->user)->post($this->url, ['category_id' => $category_id])->assertSessionHasErrors('category_id');
    ...
    it('validates price field properly', function (mixed $price) {
        ...
        $this->actingAs($this->user)->post($this->url, ['price' => $price])->assertSessionHasErrors('price');
    ...
    it('validates spent at field properly', function (mixed $spent_at) {
        ...
        $this->actingAs($this->user)->post($this->url, ['spent_at' => $spent_at])->assertSessionHasErrors('spent_at');
